...
different categories such as Products, Financing, FinaHive For, Resources, and Legal. Each section
      ...
      <section className="h-fit w-screen bg-foreground text-background !overflow-hidden">
        <div className="overflow-hidden container py-24 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 w-full space-y-8 xl:space-y-0 gap-4">
            ...
            <div className="flex flex-col space-y-4 items-start">
              <h6 className="text-lg font-bold">FinaHive For</h6>
              <div className="grid grid-cols-2 lg:grid-cols-1 text-sm gap-2.5">
                <div className="space-y-2">
                  <Link className="block" href="">
                    Businesses
          ...
          <div className="pt-8 lg:pt-14 flex flex-col items-start lg:flex-row lg:items-center gap-4 lg:justify-between w-full">
            ...
            <p className="text-xs w-fit">
              Copyright © 2024 FinaHive Technologies Inc | All Rights Reserved
            </p>
          </div>
          ...
          <div className="text-xs space-y-3.5 pt-6">
            <p>
              *Disclaimer: FinaHive Advisory LLC is a registered investment
              adviser. Registration as an investment adviser does not imply any
              level of skill or training.
            </p>

            <p>
              For accounts opened through Atomic Brokerage LLC: FinaHive Advisory
              ...
              Brokerage services for customers of FinaHive Advisory LLC are
            ...
            <p>
              ...
              LLC: FinaHive Advisory LLC has an engagement with Atomic Invest, LLC
              ...
              and free cash interest earned by customers with FinaHive Advisory
              LLC. FinaHive Advisory LLC is not a client of Atomic Invest, but our
            ...
            <p>
              **Disclaimer: The interest rate and annual percentage yield may
              ...
              rate sheet for additional information. FinaHive Technologies is a
              financial technology company, not an FDIC-insured depository
              institution, bank or credit union, and your account at FinaHive is
              not, itself, an FDIC-insured product.
            </p>

            <p>
              By opening a Maximum Checking account through FinaHive and if you
              ...
              FinaHive and/or pursuant to applicable law. Terms and restrictions
